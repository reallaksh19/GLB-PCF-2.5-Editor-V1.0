...
- Name: tests/phase10-dxf.test.js >> Phase 10 — DXF Import + Export >> 10.6 — DXF export: file contains SECTION and LINE entities
- Location: tests/phase10-dxf.test.js:66:3
