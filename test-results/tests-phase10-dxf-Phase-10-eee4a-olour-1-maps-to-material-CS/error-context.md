...
- Name: tests/phase10-dxf.test.js >> Phase 10 — DXF Import + Export >> 10.4 — DXF import: ACI colour 1 maps to material CS
- Location: tests/phase10-dxf.test.js:49:3
  ...
  - main [ref=e21]:
    - tabpanel [ref=e22]:
      - generic [ref=e23]:
        ...
        - button "🔬 DXF Import" [active] [ref=e62] [cursor=pointer]
